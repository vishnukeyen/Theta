%%% Each data set represent different no of peaks picked to check the symmetry ranging from 5ms - 100ms 
...
for rr=3:length(pd) % Directory variable (Session variable)
    ...
    tit=sprintf('Delta with #peaks',tdly);% Title for the figure.    
    figure;
    hist(dipkd1{rr},20);
