...
cd('/data/keyen/everything_related_to_data/Processed/Enclosure/others');
p=dir;
...
for aa=1:s
    ...
    zz=aa;
    %% Variables
    eeg=variables(aa).eeg;
    Hz=variables(aa).Hz;
    posx=variables(aa).posx;posy=variables(aa).posy;
    signaltheta=variables(aa).theta;signaldelta=variables(aa).delta;    
    ...
    name=sprintf('/data/keyen/everything_related_to_data/Processed/Enclosure/Version1/Downsampled_match_timepoints_%d',aa);
    save(name,'data');
    ...
    name=sprintf('/data/keyen/everything_related_to_data/Processed/Enclosure/Version1/Upsampled_interpolation_%d',aa);
    save(name,'data');
    clear data speed direction acceleration;
end
